export const metadata = {
  title: 'Contact',
  description: 'Get in touch for security engineering roles. Email, phone, LinkedIn, GitHub, resume download.',
}
  ...
  return (
    <div className="wrap pt-24 pb-20 md:pt-32">
      ...
      <div className="mt-12 max-w-lg space-y-5">
        <a href="mailto:gppamarthy@gmail.com" className="flex items-center gap-3 text-lg hover:text-accent transition-colors group">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-subtle group-hover:text-accent shrink-0">
            <rect x="2" y="4" width="20" height="16" rx="2"/><path d="M22 4L12 13 2 4"/>
          </svg>
          gppamarthy@gmail.com
        </a>
        <a href="tel:+12404958089" className="flex items-center gap-3 text-lg hover:text-accent transition-colors group">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-subtle group-hover:text-accent shrink-0">
