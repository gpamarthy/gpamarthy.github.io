      ...
      <div className="wrap py-12 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <div className="flex gap-8 items-center text-[10px] font-mono uppercase tracking-widest text-muted">
          ...
          <div className="flex gap-5 items-center">
            <a href="https://www.linkedin.com/in/gpamarthy" target="_blank" rel="noreferrer" className="hover:text-accent transition-colors" aria-label="LinkedIn">
            ...
            <a href="mailto:gpamarthy@gmail.com" className="hover:text-accent transition-colors" aria-label="Email">
